...
.drawHeart1:
  ...
  LDA heartTimer
  CMP #0
  ;;BEQ .setYPos        ;giving me fits


  TYA                   ;increment to horizontal position
  ADC #3
  TAY 

  LDA sprites, y        ;load horizontal position
  ADC heartTimer
 ;; ADC #$28               ;offset right px
  STA spriteRam, y
  TYA
  ADC #1
  TAY
...
.hideHeart:
  ...
  TAY
  LDA #%00000001
  ;STA spriteRam, y      ;giving me fits
  TYA
  ADC #3
  TAY
  JMP .drawHeart1
...
advanceHeartTimer:
  ...
  LDA heartTimer
  ADC #8              ;;controls speed of the hearts
  STA heartTimer
  RTS
...
sprites:
  ...
  ;;heart
  .db $00, $BA, %00000001, $00
  .db $08, $CA, %00000001, $00
  .db $00, $BA, %01000001, $08 
  .db $08, $CA, %01000001, $08
